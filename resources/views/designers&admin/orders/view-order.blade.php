<x-layout>
        ...
        <div class="w-full mx-auto bg-white shadow-xl rounded-2xl p-8 border border-gray-100 space-y-10">
            ...
            <div class="grid grid-cols-2 md:grid-cols-5 gap-6 text-gray-800">
                ...
                <div>
                    ...
                    <p class="{{ Str::startsWith($order->completed_at, '-') ? 'text-red-600 font-semibold' : 'text-gray-700' }}">
                        {{ $order->completed_at ?? 'Unknown' }}
                    </p>
    ...
    <div class="mt-10">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            {{-- Changed $path to $imageArray for clarity, as it's an array --}}
            @foreach($images as $imageArray) 
                <div class="image-block border rounded-xl shadow-lg p-4 bg-white hover:shadow-xl transition duration-300 space-y-4 text-center">
                    ...
                    {{-- Use $imageArray['path'] for the actual file path --}}
                    ...
                    <p class="text-sm text-gray-700 mt-2">
                        {{-- Use $imageArray['original_name'] if available, otherwise fallback to basename of the path --}}
