<x-layout>
    <div class="mt-5 mb-5 p-5">
        ...
        <form action="{{ route('qc.updatemainorders', $order->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" id="title" name="title" value="{{ old('title', $order->project_title) }}" required disabled>
            </div>
        ...
        <div class="mb-3">
            ...
            <div class="row">
                ...
                <select id="service" class="form-select" name="request_type" required disabled >
            ...
            <div class="mb-3">
                ...
                <textarea name="instructions" id="instructions" class="form-control" rows="6" disabled>{{ old('instructions', $order->instructions) }}</textarea>
            </div>

            <!-- Instructions (Rich Text) -->
            <div class="mb-3">
                <label for="admin_notes" class="form-label"><strong>Admin Notes:</strong></label>
                <textarea name="admin_notes" id="admin_notes" class="form-control" rows="6" disabled>{{ old('admin_notes', $order->admin_notes) }}</textarea>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" name="colors" id="colors" value="{{ old('colors', $order->colors) }}" placeholder="e.g., #ffffff, #000000" disabled>
                </div>
                <div class="col-md-6">
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="software" name="software" disabled>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" id="brand_profile_id" name="brand_profile_id" disabled>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" name="pre_approve" id="pre_approve" value="{{ old('pre_approve', $order->pre_approve) }}" min="0" step="1" disabled>
            </div>

            <!-- Reference Files Upload -->
            <div class="mb-3">
                <label for="reference_files" class="form-label fw-semibold">Upload Reference Files</label>
                <input class="form-control" type="file" name="reference_files[]" id="reference_files" multiple  disabled>
