    ...
    <div class="container-fluid mt-5 pt-4 mb-5 pb-5">
      <div class="page-inner">
        <div class="page-header">
          <h3 class="fw-bold mb-3">Main Orders</h3>
            ...
            <div class="card">
              <div class="card-header d-flex justify-content-between align-items-center">
                <div class="search-sort-filter flex gap-x-3">
                  <input type="text" class="form-control" id="qc_mainjob_search" placeholder="Search...">
          
                  <select id="qc_mainstatus_filter" class="form-control px-3 py-2 border rounded-md">
                  ...
                  <a href="{{ route('qc.mainorders') }}" class="px-4 py-[9px] rounded-md bg-blue-500 text-white hidden" id="filter_reset">Reset</a>
                </div>
                  ...
                  <table class="min-w-full divide-y divide-gray-200 bg-white shadow-md rounded-lg">
                      ...
                      <tbody class="divide-y divide-gray-200 text-sm text-gray-800" id="orders_table_body">
                          @foreach($orders as $order)
                            ...
                            <tr class="{{ $rowClass }}">
                                <td class="px-4 py-3"><a href="{{ route('qc.viewmainjob', $order->id) }}" class="hover:underline">{{ $order->order_id ?? '-' }}</a></td>
                                ...
                                <td class="px-4 py-3">
                                  ...
                                  <td class="px-4 py-2 flex gap-3">
                                        <a href="{{ route('qc.viewmainjob', $order->id) }}" class="text-indigo-600 hover:underline">View</a>
                                        <a href="{{ route('qc.editmainjob', $order->id) }}" class="text-indigo-600 hover:underline">Edit</a>
                                  </td>
                              </tr>
                          @endforeach
                      </tbody>
